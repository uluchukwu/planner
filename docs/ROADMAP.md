...
## Phase 6 — Android — all planner screens done, Settings/sync/push/sharing not started

Built across three passes, sequenced deliberately (screens first, then the harder pieces, per an explicit choice when this phase started):
