...
const PATHS: Record<NavItem["icon"], string> = {
  ...
  import: "M12 3.5 13.4 8.6 18.5 10 13.4 11.4 12 16.5 10.6 11.4 5.5 10 10.6 8.6 12 3.5Z M18.5 14 19.3 16.7 22 17.5 19.3 18.3 18.5 21 17.7 18.3 15 17.5 17.7 16.7 18.5 14Z",
};
